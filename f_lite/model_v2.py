...
class DiTBlock(nn.Module):
    ...
    def forward(self, x, x_cu_seqlens, x_max_seqlen_in_batch, context, context_cu_seqlens, context_max_seqlen_in_batch, t_emb, rope, token_length):
        modulation = self.adaLN_modulation(t_emb)
        modulation = modulation.repeat_interleave(token_length, dim=0)
        (
            shift_sa,
            scale_sa,
            gate_sa,
